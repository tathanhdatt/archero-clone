...
[CreateAssetMenu(menuName = "Ability Upgrade/Int Variable Upgrade")]
public class IntVariableUpgrade : AbilityUpgradeComponent
{
    [SerializeField]
    ...
    public override void Upgrade()
    {
        switch (this.modifiedType)
        {
            ...
            case NumberModifiedType.AddWithPercentage:
                this.variable.Value += (int)(this.variable.Value * this.percentage);
                break;
            default:
